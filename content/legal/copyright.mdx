...
Packs owned by haruhime pools are past osu! tournament mappools published from [pools.haruhime.moe](https://pools.haruhime.moe), which credits where each pool comes from, such as [otdb](https://otdb.sheppsu.me) by Sheppsu.
