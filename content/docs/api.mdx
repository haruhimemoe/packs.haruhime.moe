...
"archive": {
  ...
  "fingerprint": "5e0c…",
  "sources": [
    { "kind": "otdb", "id": "657", "url": "https://otdb.sheppsu.me/mappool/657", "importedAt": "2026-09-24T12:00:00.000Z" }
  ]
}
```
...
- 2026-09-24: archive packs (past tournament pools) carry `archive`, and their index entries carry `x`, `xk` and `xu`.
