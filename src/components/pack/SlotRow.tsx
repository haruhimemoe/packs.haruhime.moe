 ...
 *       Copy ID (the beatmap ID, for "!mp map"), and optional move and remove. A press of Copy ID
 *       never moves the row: its status has room kept for it. Editable rows put their controls on
