 ...
 *       star rating and speed, and how much osu! and mirror work one stats run may do. Shared by
 *       the server (which computes stats) and the browser (which filters on them).
